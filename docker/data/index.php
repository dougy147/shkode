...
<head>
    ...
    <!--reduce flashbang for some browsers when reloading code-->
...
<body>
    <center>
	<h1><span style="color:grey">#!/usr/bin/live</span> <span style="color:yellow">shkode</span></h1>

	<div>
	    <p>Stream your code to a live-refreshed webpage.</p>
